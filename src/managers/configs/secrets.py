...
class SecretConfig(BaseModel):
    ...
    literal_api_key: StrictStr = Field("secret-literal-api-key", description="Literal API Key")

    # local integrations
    db_conn_str: StrictStr = Field("secret-db-conn-str", description="Database connection string")
